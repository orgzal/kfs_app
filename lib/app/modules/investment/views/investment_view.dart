...
class InvestmentView extends GetView<InvestmentController> {
  ...
  Widget build(BuildContext context) {
    final args = _DetailsData.fromArguments(
      Get.arguments,
      fallbackTitle: 'تفاصيل الفرصة الاستثمارية',
      fallbackDescription: 'لا يوجد وصف متاح لهذه الفرصة حاليًا.',
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: hasImage
          ...
          : const _DetailsImagePlaceholder(icon: Icons.trending_up_rounded),
    );
  }
}
