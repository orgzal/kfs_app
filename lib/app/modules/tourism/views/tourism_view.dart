...
class TourismView extends GetView<TourismController> {
  ...
  Widget build(BuildContext context) {
    final args = _DetailsData.fromArguments(
      Get.arguments,
      fallbackTitle: 'تفاصيل الوجهة السياحية',
      fallbackDescription: 'لا يوجد وصف متاح لهذه الوجهة حاليًا.',
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: hasImage
          ...
          : const _DetailsImagePlaceholder(icon: Icons.landscape_rounded),
    );
  }
}
